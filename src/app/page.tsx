...
export default function Home() {
  ...
  return (
    ...
    <>
      <div className="bg-slate-600 w-full h-screen py-10">
        <div className="gray-div bg-opacity-30 w-full max-w-md mx-auto text-center shadow-2xl rounded-xl px-4 py-8 text-orange-400 bg-white">
          ...
          <div
            ...
            <input
              ...
              ref={passwordRef} />
            <button
              className="outline-none bg-blue-600 rounded-r-lg text-white px-3 py-0.5 shrink-0"
              onClick={
